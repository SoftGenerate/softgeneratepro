...
export const Projects = () => {
  ...
  const testimonials = [
    ...
    { name: "Gopal Gupta", review: "Great people to work with. They are full of professional etiquette and true ethics. Such an amazing team with clear skills and quality techniques.", rating: 5 }
  ];
